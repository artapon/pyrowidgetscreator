<section class="title" style="width: 45%;float: left;" >
<h4><?php echo lang('pyro_widgets_creator.title'); ?></h4>
</section>
<section class="title" style="position:relative;width: 50%;float:left;margin-left: 5%;" >
<h4><?php echo lang('pyro_widgets_creator.option'); ?></h4>
</section>
<div style="clear: both;"></div>
<?php echo form_open(uri_string()); ?>
<section class="item "  style="width: 45%;margin-right: 5%" >
	<div class="tabs">
...
<section class="item" style="width: 50%;" >
	<fieldset>
					<table border="0" >
						<tbody>
							<tr>
